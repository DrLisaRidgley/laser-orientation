...
-   What is the average points earned?

-   What is the highest percentage someone earned?
...
-   scores or values of different variables
...
```{r}
d |> 
  filter(FinalGradeCEMS > 55)
```

What happens when you change the cut-off from 70 to something else? Add
a thought (or more):

-   It changes the number of observations based on how many fit the
    filter.
